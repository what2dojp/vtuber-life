...
export const CAREER_CHOICES: Record<number, CareerChoicePhase> = {
  12: {
    month: 12,
    phaseTitle: "【第 12 個月】職涯重大轉折：企業勢選秀與路線抉擇",
    subtitle:
    ...
    options: [
      {
        ...
        tag: "【高流量／高壓力】",
        description:
          "獲得強大的資源推廣與箱推連動，但合約極度嚴苛，抽成 90% 且每個月都要達到 KPI！",
        effects: {
          fansBoost: 15000,
          sanBoost: -25,
          dramaBoost: 15,
      ...
      },
      {
        ...
        tag: "【溫馨互助／均衡】",
        description:
          "與志同道合的小 V 組成同人社團，互相拉拔與凸待，共同衝刺四週年萬定！",
        effects: {
          fansBoost: 6000,
          sanBoost: 15,
          dramaBoost: 0,
  ...
  24: {
    ...
    options: [
      ...
      {
        id: "collab_marathon",
        title: "舉辦 24 小時四週年跨界連動馬拉松",
        tag: "【溫馨／穩定】",
        description:
          "邀請包括可樂月月在內的 24 位同業 VTuber 接力直播，將社群溫暖度拉到最高！",
        effects: {
          fansBoost: 12000,
          sanBoost: 20,
          dramaBoost: -20,
