...
export const RANDOM_EVENTS: GameEvent[] = [
  {
    id: "colamoon_collab",
    title: "【大先輩連動】四周年特別企劃！與「可樂月月」合作直播！",
    description:
      "快要突破 10,000 訂閱大關的台灣 VTuber 先輩「可樂月月」邀請你參加四周年紀念凸待！直播間瞬間湧入大量熱情觀眾，彈幕刷爆！",
    options: [
      {
        label: "【穩健】禮貌獻上四周年祝福，擔任貼心綠葉與主持人。",
        type: "steady",
        chance: 95,
        success: {
      ...
      {
        label: "【標準】現場大聲宣傳：『祝賀月月 4 周年快樂！快去訂閱 @colamoonie！』",
        type: "standard",
        chance: 85,
        success: {
      ...
      },
      {
        ...
        chance: 60,
        success: {
          log: "兩人的歌聲驚艷全場！合唱精采絕倫，剪輯精華在 Twitter 爆火傳播！",
          fans: 6000,
          singing: 10,
          san: 15,
        },
  ...
  },
  {
    ...
    options: [
      ...
      {
        label: "【迷因】直接在直播間安祥躺平，開啟 8 小時「睡覺耐久」！",
        type: "meme",
        chance: 60,
        success: {
  ...
  },
  {
    ...
    description:
      "卡關卡在絕望的 Boss 前整整 12 個小時，你的精神 SAN 值與嗓子都已經來到了崩潰邊緣...",
    options: [
      {
        ...
        chance: 90,
        success: {
          log: "觀眾讚許你的健康作息，熱情留言預約明天通關 момент！",
          fans: 1000,
          san: 15,
        },
        failure: {
      ...
      {
        label: "【標準】邀請遊戲高人觀眾進行「線上遠程教練」指導戰術！",
        type: "standard",
        chance: 75,
        success: {
  ...
  },
  {
    ...
    description:
      "昨天滿意無比的歌回直播，今天收到版權炮打擊，影片遭到強制下架甚至有封頻道風險！",
    options: [
      {
      ...
      {
        label: "【標準】將所有歌曲改編為「無版權自製口技（B-Box）版」重唱！",
        type: "standard",
        chance: 70,
        success: {
  ...
  },
  {
    ...
    options: [
      {
        label: "【穩健】緊急切換回預設 static 圖片，冷靜聯繫繪師與模型師修復。",
        type: "steady",
        chance: 90,
        success: {
      ...
      },
      {
        ...
        chance: 40,
        success: {
          log: "前衛的抽象美學引發同人繪師狂熱創作潮流！爆火出圈！",
          fans: 9000,
          tech: 10,
          drama: 20,
        },
        failure: {
          log: "模型徹底當機卡死，畫面直接變成一片藍屏死機... ",
          san: -30,
          drama: 25,
        },
      },
  ...
  },
  {
    ...
    description:
      "直播中突發有石油王連續砸下大額紅色 SuperChat，內容卻是偏執的真情告白與情緒勒索要求交往...",
    options: [
      {
      ...
      {
        label: "【迷因】切換為「極道大哥人格」，現場給石油王進行社會洗禮！",
        type: "meme",
        chance: 55,
        success: {
          log: "霸氣的反差魅力反而吸引了更多「被虐狂」抖內狂熱者！",
          fans: 6000,
          talk: 10,
          san: 15,
        },
  ...
  },
  {
    ...
    title: "【同箱撕逼】同箱連動成員突發 Twitter 相互退追！",
    description:
      "社群偵探發現你與同箱的好友 VTuber 突然取消關注對方，全網開啟「大解析時代」猜測內部霸凌！",
    options: [
      {
        label: "【穩健】發布聯合聲明澄清只是系統 Bug，並曬出私下合照。",
        type: "steady",
        chance: 90,
        success: {
  ...
  },
  {
    ...
    description:
      "接到了高額廠商工商，但在現場試用時產品突然故障，或者不小心脫口說出產品的缺點...",
    options: [
      {
  ...
  },
  {
    ...
    options: [
      ...
      {
        label: "【豪賭】邀請 10 位同業 VTuber 進行「跨宵夜接力合唱」挑戰！",
        type: "gambling",
        chance: 55,
        success: {
  ...
  },
  {
    ...
    title: "【演算降臨】演算神明眷顧！精華烤肉 Short 爆發式病毒傳播！",
    description:
