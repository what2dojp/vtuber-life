...
export const RANDOM_EVENTS: GameEvent[] = [
  ...
  {
    id: "obs-still-live",
    title: "【下播事故】你以為關台了，紅點還在跳",
    description:
      "你跟觀眾說晚安、切待機圖、關掉燈光。十分鐘後 Discord 私訊炸開：『妳還在播。』OBS 的紅點比你的自制力更持久。🔴\n\n彈幕正在實況你的真實人生：刷牙、滑手機、對空氣碎念『今天好累』。有人已經開始做時間軸。你的皮套還在笑，你的中之人正在過普通的夜。",
    options: [
      {
        label: "【穩健】秒切結束推流，只留一句『麥克風有沒有 OK』當都市傳說",
        chance: 84,
        success: {
          log: "你以殘血速度關掉推流。彈幕只捕捉到模糊的刷牙聲，古參當成 ASMR 隱藏軌。",
          fans: 90,
          san: -4,
          tech: 2,
        },
        failure: {
          log: "結束推流按到場景切換。觀眾完整看見你走去倒水，切片標題寫《VTuber 的真實水分》。",
          fans: 40,
          san: -12,
          drama: 14,
        },
      ...
      {
        label: "【標準】立刻角色化：這是『晚安後的秘密雜談』",
        chance: 70,
        success: {
          log: "你假裝這是加時賽。彈幕買帳，有人說這才是本體，同接不降反升。",
          fans: 260,
          san: -2,
          talk: 3,
          drama: 4,
        ...
        failure: {
          log: "角色化失敗，因為你剛好唸出外送訂單編號。秘密雜談變成公開菜單。",
          fans: 20,
          san: -10,
          drama: 16,
        },
      ...
      {
        label: "【豪賭】乾脆開箱今晚的真實人生，做成特別節目",
        chance: 32,
        success: {
          log: "破防開箱意外成為神回。觀眾說『這才叫個人勢』，隔天訂閱曲線像心跳。",
          fans: 880,
          san: -14,
          talk: 4,
          drama: 12,
        ...
        failure: {
          log: "真實人生太真實。家人在鏡頭外喊你的本名，解析文比 VOD 還長。",
          fans: -30,
          san: -22,
          drama: 26,
        },
      ...
      {
        label: "【迷因】宣布以後每晚都有『幽靈加時』，紅點是設定",
        chance: 50,
        success: {
          log: "幽靈加時成為品牌。觀眾開始猜今晚紅點會不會留下來，你的下播變成彩票。",
          fans: 310,
          san: 2,
          talk: 3,
          drama: 8,
        ...
        failure: {
          log: "有人報案說頻道鬧鬼。你花一場澄清紅點不是靈異事件，是 OBS。",
          fans: 40,
          san: -8,
          drama: 12,
        },
  ...
  {
    id: "singing-key-crack",
    title: "【歌回】原 key 太高，聲音先畢業",
    description:
      "你堅持『這首都是原調才有靈魂』。前奏還很美，副歌第一個高音讓 Live2D 嘴巴開到最大，音準已經去旅行。🎤💥\n\n彈幕從『好聽！』變成『卡』『這也是初配信的一環嗎』。伴奏還在走，你的 SAN 已經在找下一個轉調。",
    options: [
      {
        label: "【穩健】立刻降 key，當成『深夜柔和版本』",
        chance: 86,
        success: {
          log: "降 key 救了這晚。有人說比較有味道，你把『柔和版』寫進歌單備註。",
          fans: 160,
          san: 4,
          singing: 3,
        },
        failure: {
          log: "降 key 降到變成朗讀。彈幕開始點名『這是詩朗誦台嗎』。",
          fans: 20,
          san: -8,
          drama: 8,
        },
      ...
      {
        label: "【標準】重唱一次，並承認剛才是熱身",
        chance: 72,
        success: {
          log: "第二次成功穩住。觀眾原諒熱身理論，歌力看起來比實際更專業。",
          fans: 240,
          san: -2,
          singing: 4,
        },
        failure: {
          log: "第二次裂得更乾脆。熱身理論破產，精華只剪副歌事故。",
          fans: -20,
          san: -12,
          drama: 12,
        },
      ...
      {
        label: "【豪賭】不降 key，用氣勢把它唱過去",
        chance: 28,
        success: {
          log: "你硬唱上去了。彈幕刷 7777777，有人以為你請了專業配唱，這晚直接神台。",
          fans: 720,
          san: -16,
          singing: 6,
          drama: 8,
        ...
        failure: {
          log: "氣勢沒能代替音準。你的高音成為本週最長的『卡』，連待機室都在笑。",
          fans: -40,
          san: -18,
          drama: 18,
        },
      ...
      {
        label: "【迷因】把破音編成新編曲，宣布這是『概念專輯』",
        chance: 48,
        success: {
          log: "概念專輯意外有人信。有切片標《前衛聲樂》，你的事故變成藝術。",
          fans: 280,
          san: 2,
          singing: 2,
          talk: 2,
        ...
        failure: {
          log: "藝術理論沒救到副歌。觀眾只想聽原曲，你的概念被標成跑調。",
          fans: 10,
          san: -10,
          drama: 12,
        },
  ...
  {
    id: "sc-wrong-name",
    title: "【SC】你把贊助者的名字唸成別人的仇人",
    description:
      "Super Chat 跳出來，金額很漂亮，名字很危險。你唸成了另一個常駐觀眾的外號，而那兩位正在黑歷史 wiki 上互相出現。💸📛\n\n彈幕瞬間分成兩隊。你還在感謝『支持』，戰場已經在聊天室開打。",
    options: [
      {
        label: "【穩健】立刻更正並鞠躬道歉，再把 SC 重讀一次",
        chance: 88,
        success: {
          log: "你更正得很快。雙方接受這是口誤，這則 SC 反而變成和解現場。",
          fans: 180,
          san: -2,
          talk: 2,
        },
        failure: {
          log: "更正時又唸錯第三次。現場變成名字輪盤，SAN 比金額掉得更快。",
          fans: 20,
          san: -12,
          drama: 14,
        },
      ...
      {
        label: "【標準】當成諧音梗，請雙方一起笑過去",
        chance: 66,
        success: {
          log: "諧音梗成功滅火。兩位仇人難得一起刷草，你成為意外的外交官。",
          fans: 260,
          san: 2,
          talk: 3,
          drama: 4,
        ...
        failure: {
          log: "有人覺得被消音。外交失敗，聊天室進入冷靜期，也就是全員已讀。",
          fans: -50,
          san: -10,
          drama: 16,
        },
      ...
      {
        label: "【豪賭】公開讀出兩人的『和解條件』當節目效果",
        chance: 30,
        success: {
          log: "和解條件變成單元。兩人在 SC 互相丟禮物，這晚的戲劇性高過任何劇本。",
          fans: 640,
          san: -12,
          talk: 3,
          drama: 14,
        ...
        failure: {
          log: "和解條件被當成站隊。你被夾在中間，這則 SC 變成導火線。",
          fans: -80,
          san: -20,
          drama: 24,
        },
      ...
      {
        label: "【迷因】宣布以後所有 SC 都用『那位』代替名字",
        chance: 52,
        success: {
          log: "『那位』成為新稱謂。觀眾開始比賽誰是今晚的那位，衝突被抽象化。",
          fans: 220,
          san: 4,
          talk: 3,
          drama: 6,
        ...
        failure: {
          log: "贊助者想被唸名字。『那位』被解讀成不尊重，你把這套話術收回去。",
          fans: -30,
          san: -8,
          drama: 12,
        },
  ...
  {
    id: "birthday-pc-explode",
    title: "【生日台】蛋糕還沒切，電腦先畢業",
    description:
      "待機室擠滿回來的古參。你剛唱完生日歌，畫面變成黑的，風扇發出此生最響的一聲。🎂💻\n\n彈幕還在刷『生日快樂』，你已經在黑暗裡按電源鍵。這不是驚喜，這是硬體選擇這天離職。",
    options: [
      {
        label: "【穩健】改用手機開臨時台，先把蛋糕切完",
        chance: 80,
        success: {
          log: "手機臨時台意外溫馨。畫質很差，心意很滿，古參說這才像生日。",
          fans: 280,
          san: -4,
          talk: 2,
          tech: 1,
        ...
        failure: {
          log: "手機熱到關機。雙平台畢業，你在黑暗中對空氣說生日快樂。",
          fans: 40,
          san: -14,
          drama: 10,
        },
      ...
      {
        label: "【標準】宣布延後一小時，並把待機室變成點歌廳",
        chance: 68,
        success: {
          log: "點歌廳撐住人潮。電腦冷卻回來後同接還在，生日台從事故變成加場。",
          fans: 320,
          san: -6,
          talk: 3,
        },
        failure: {
          log: "一小時後還是黑屏。點歌廳變成離席潮，蛋糕在鏡頭外融化。",
          fans: -40,
          san: -16,
          drama: 12,
        },
      ...
      {
        label: "【豪賭】邊組裝備用電腦邊直播，做成耐久維修台",
        chance: 34,
        success: {
          log: "維修台爆紅。有人是來看生日的，更多人是來看你跟螺絲對線，神台預定。",
          fans: 900,
          san: -18,
          tech: 5,
          drama: 10,
        ...
        failure: {
          log: "螺絲掉進機殼。維修台變成默哀，你的生日願望是『請先開機』。",
          fans: -20,
          san: -22,
          drama: 16,
        },
      ...
      {
        label: "【迷因】宣布電腦也過生日，今晚是雙壽星",
        chance: 54,
        success: {
          log: "雙壽星設定太荒謬所以成功。彈幕開始對電源供應器唱生日歌，抽象祝福成立。",
          fans: 240,
          san: 2,
          talk: 3,
          drama: 8,
        ...
        failure: {
          log: "電腦沒有感受到愛。它繼續黑屏，你的雙壽星只剩你一個人吹蠟燭。",
          fans: 30,
          san: -8,
          drama: 8,
        },
  ...
  {
    id: "discord-mod-war",
    title: "【社群】管理員互相 timeout，伺服器進入內戰",
    description:
      "你上線看到公告被改了三次。兩位管理員為了『要不要禁轉播連結』已經把對方 timeout 到明年。🛡️⚔️\n\n觀眾問你站哪邊。你只是想開雜談。Discord 比待機室還熱鬧，而且更危險。",
    options: [
      {
        label: "【穩健】暫停權限、私訊雙方、把規則寫清楚",
        chance: 82,
        success: {
          log: "你當了一次真正的社長。規則貼出去後戰場降溫，社群暫時恢復能聊天的狀態。",
          fans: 140,
          san: -6,
          talk: 2,
        },
        failure: {
          log: "私訊被截圖。中立變成雙面討好，兩邊都不滿意，你開始想念只有三人的時期。",
          fans: -40,
          san: -14,
          drama: 18,
        },
      ...
      {
        label: "【標準】開一場『社群公聽會』直播處理",
        chance: 64,
        success: {
          log: "公聽會意外好看。規則被投票出來，這場雜談比任何遊戲實況更有張力。",
          fans: 300,
          san: -8,
          talk: 4,
          drama: 8,
        ...
        failure: {
          log: "公聽會變成修羅場。直播標題該改成《我的伺服器為什麼會這樣》，SAN 直接掉段。",
          fans: -70,
          san: -18,
          drama: 22,
        },
      ...
      {
        label: "【豪賭】解散管理組，宣布從今晚起你一個人審核",
        chance: 28,
        success: {
          log: "獨裁暫時有效。垃圾訊息變少，你的睡眠也變少，但社群稱你為夜班社長。",
          fans: 220,
          san: -16,
          drama: 10,
        },
        failure: {
          log: "一個人審核到天亮。廣告機器人佔領公告頻道，你理解為什麼要有管理員。",
          fans: -90,
          san: -24,
          drama: 16,
        },
      ...
      {
        label: "【迷因】把內戰編成伺服器活動『管理員大逃殺』",
        chance: 46,
        success: {
          log: "大逃殺活動爆紅。衝突被遊戲化，雙方為了贏而暫時合作，你的抽象治理成功。",
          fans: 360,
          san: -4,
          talk: 3,
          drama: 12,
        ...
        failure: {
          log: "有人覺得被當笑話。活動貼文被認真檢舉，你把大逃殺從公告裡刪掉。",
          fans: -50,
          san: -12,
          drama: 18,
        },
  ...
  {
    id: "sleep-stream-snore",
    title: "【睡眠台】ASMR 變成打呼比賽",
    description:
      "你說要陪大家睡覺。前三十分鐘呼吸很穩，第三十一分鐘你發出此生最不 ASMR 的聲音。😴🎤\n\n彈幕從『晚安』變成『這真的可以播嗎』『打呼也太真實』。有人開了音量視覺化，你的鼻子成為今夜主角。",
    options: [
      {
        label: "【穩健】設鬧鐘兩小時後下播，承認自己睡著了",
        chance: 84,
        success: {
          log: "你誠實下播。觀眾覺得真實，睡眠台仍被標成溫馨回，只是多了鼻息彩蛋。",
          fans: 150,
          san: 6,
        },
        failure: {
          log: "鬧鐘沒響。八小時後你在精華裡看見自己的睡顏（皮套版），社死延遲生效。",
          fans: 60,
          san: -10,
          drama: 12,
        },
      ...
      {
        label: "【標準】醒來後把打呼編成『龍族呼吸法』",
        chance: 70,
        success: {
          log: "龍族呼吸法成為新設定。有人當真去練，更多人把它當晚安 BGM。",
          fans: 240,
          san: 2,
          talk: 3,
          drama: 6,
        ...
        failure: {
          log: "呼吸法沒人信。彈幕只記得鼻息，你的 ASMR 人設暫時退休。",
          fans: 20,
          san: -8,
          drama: 10,
        },
      ...
      {
        label: "【豪賭】宣布挑戰 12 小時睡眠耐久，打呼也算內容",
        chance: 30,
        success: {
          log: "耐久睡眠台創造同接奇蹟。有人是來看你會不會翻身，這很荒謬，所以很賺錢。",
          fans: 780,
          san: -10,
          drama: 8,
        },
        failure: {
          log: "你中途被自己的打呼嚇醒並慘叫。睡眠台變成驚嚇台，推薦演算法很困惑。",
          fans: 80,
          san: -16,
          drama: 16,
        },
      ...
      {
        label: "【迷因】把鼻息波形做成待機圖，開賣『助眠限定』",
        chance: 50,
        success: {
          log: "助眠限定莫名有人要。你的鼻子成為週邊，這不是你出道時的夢想，但訂閱漲了。",
          fans: 300,
          san: 2,
          drama: 10,
        },
        failure: {
          log: "待機圖被說太抽象。有人以為是故障，你把波形從頻道藝術裡撤下來。",
          fans: 10,
          san: -6,
          drama: 8,
        },
  ...
  {
    id: "fanart-wrong-oc",
    title: "【同人】你把別人的角色當成自己大喊可愛",
    description:
      "繪師投稿一張超可愛圖。你激動到破音：『這就是我——』然後發現髮型、瞳色、甚至種族都不是你。🎨😵\n\n真正的本人正在聊天室。繪師也在。空氣凝固成精華素材。",
    options: [
      {
        label: "【穩健】立刻道歉，並認真介紹正確的角色",
        chance: 90,
        success: {
          log: "你道歉得很漂亮。繪師原諒你，正確的角色還被你安利了一波，形象回血。",
          fans: 200,
          san: -2,
          talk: 2,
        },
        failure: {
          log: "介紹時又叫錯第二次。現場變成角色測驗，你的觀察力被公開處刑。",
          fans: 30,
          san: -10,
          drama: 12,
        },
      ...
      {
        label: "【標準】承認眼花，並當場連動那位真正的主人",
        chance: 62,
        success: {
          log: "緊急連動意外成功。兩台互相安利，認錯變成緣分，訂閱兩邊都吃到。",
          fans: 420,
          san: 4,
          talk: 3,
          drama: 4,
        ...
        failure: {
          log: "對方沒開台。你在空的 Discord 通話裡道歉，這畫面比認錯更慘。",
          fans: 40,
          san: -8,
          drama: 8,
        },
      ...
      {
        label: "【豪賭】宣布這是平行世界的自己，邀請繪師出設定",
        chance: 34,
        success: {
          log: "平行世界設定太瘋所以過關。繪師真的補了設定稿，你多了一個官方不正經的分身。",
          fans: 560,
          san: -6,
          talk: 3,
          drama: 12,
        ...
        failure: {
          log: "原主人不覺得好笑。平行世界被當成搶角色，你把這個梗從嘴邊刪掉。",
          fans: -60,
          san: -16,
          drama: 20,
        },
      ...
      {
        label: "【迷因】以後每張圖都先問『這是我嗎』當成固定台詞",
        chance: 56,
        success: {
          log: "固定台詞成為新傳統。觀眾開始惡作劇投圖，你的認圖單元意外好看。",
          fans: 260,
          san: 4,
          talk: 3,
          drama: 6,
  ...
  {
    id: "karaoke-copyright-mute",
    title: "【歌回】整場被靜音，你在無聲中努力",
    description:
      "你唱得很認真。觀眾聽不到。版權系統把伴奏、人聲、甚至你說話的氣音一併吃掉。🔇🎶\n\n彈幕全是『???』『我的音響壞了嗎』。你還在副歌裡感動，世界已經進入默劇。",
    options: [
      {
        label: "【穩健】立刻切雜談，並把歌單改成安全曲",
        chance: 84,
        success: {
          log: "你止損得很快。雜談救回這晚，歌單被標上『可以發出聲音的歌』。",
          fans: 120,
          san: -2,
          tech: 2,
        },
        failure: {
          log: "安全曲也不安全。第二首一樣被吃，你開始懷疑自己的聲音本身就是版權物。",
          fans: 10,
          san: -10,
          drama: 8,
        },
      ...
      {
        label: "【標準】改用無伴奏清唱，並說明這是『原聲特別版』",
        chance: 68,
        success: {
          log: "清唱意外動人。有人說比伴奏版更好，歌力在無聲事故裡被看見。",
          fans: 340,
          san: 4,
          singing: 4,
        },
        failure: {
          log: "清唱也破音。無聲事故加上有聲事故，這晚的層次很豐富，但不是你要的那種。",
          fans: 30,
          san: -12,
          drama: 10,
        },
      ...
      {
        label: "【豪賭】把靜音當成挑戰，做一場讀唇歌回",
        chance: 26,
        success: {
          log: "讀唇歌回爆紅。切片標題《無聲的神台》，演算法不知道該怎麼分類，所以推給所有人。",
          fans: 820,
          san: -12,
          singing: 3,
          drama: 14,
        ...
        failure: {
          log: "沒人看得懂口型。聊天室變成猜歌地獄，你唱完才發現大家在猜別的歌。",
          fans: -20,
          san: -16,
          drama: 12,
        },
      ...
      {
        label: "【迷因】宣布這是默劇演唱會，請彈幕負責配樂",
        chance: 50,
        success: {
          log: "彈幕真的開始打節奏。這場變成互動實驗，抽象但成功，你的歌回有了觀眾音軌。",
          fans: 300,
          san: 2,
          talk: 3,
          drama: 8,
        ...
        failure: {
          log: "彈幕配樂全是喇叭 emoji。現場更吵，只是聲音不在你這邊。",
          fans: 40,
          san: -8,
          drama: 10,
        },
  ...
  {
    id: "big-vtuber-raid",
    title: "【Raid】大台突然湧入，同接數字開始 vertigo",
    description:
      "你正在講昨天吃了什麼。同接從 73 跳到四位數。大前輩在聊天室丟了一句『來看看後輩』。🚀📈\n\n你的手在抖，台詞只剩下『安安』。待機室的熟客開始教新人規矩，場面像開學典禮。",
    options: [
      {
        label: "【穩健】感謝 Raid、自我介紹、把節奏放慢給新人",
        chance: 86,
        success: {
          log: "你當了個合格的接待員。有人留下來看下次，熟客說你今晚很專業。",
          fans: 480,
          san: -4,
          talk: 3,
        },
        failure: {
          log: "自我介紹唸成草稿備註。新人只記得你卡了三十秒，Raid 變成路過。",
          fans: 80,
          san: -10,
          drama: 8,
        },
      ...
      {
        label: "【標準】邀請前輩說幾句，做成即席凸待",
        chance: 60,
        success: {
          log: "即席凸待成功。前輩願意開口，這晚直接寫進雙方精華，訂閱吃到溢出。",
          fans: 1200,
          san: -8,
          talk: 4,
          drama: 6,
        ...
        failure: {
          log: "前輩已經去睡覺。你在空呼叫裡自我介紹，Raid 人群開始散場。",
          fans: 120,
          san: -12,
          drama: 6,
        },
      ...
      {
        label: "【豪賭】立刻開高難度遊戲秀操作，賭他們會留下",
        chance: 28,
        success: {
          log: "操作秀把 Raid 鎖住。彈幕刷 7777777，有人以為這台本來就這麼猛。",
          fans: 1600,
          san: -18,
          tech: 3,
          drama: 10,
        ...
        failure: {
          log: "你在新人面前 Super Chat 式地翻車。Raid 變成教學什麼是個人勢事故。",
          fans: 60,
          san: -20,
          drama: 18,
        },
      ...
      {
        label: "【迷因】對四位數同接說『安安，今天也是和平的一天』",
        chance: 52,
        success: {
          log: "反差萌成立。大台觀眾被這句和平給打敗，有人說要當新的箱推。",
          fans: 640,
          san: 4,
          talk: 3,
          drama: 6,
        ...
        failure: {
          log: "和平的一天說完你就當機。畫面凍結在微笑，Raid 見證了你的技術力。",
          fans: 90,
          san: -8,
          drama: 10,
        },
  ...
  {
    id: "vrchat-room-reveal",
    title: "【VRChat】你跌倒了，背景露出真實房間",
    description:
      "世界觀寫著『來自星間的偶像』。你在 VRChat 被一隻狗模型撞倒，頭顯歪了，鏡頭掃到衣架、零食袋，以及印著超商名稱的購物袋。🥽📦\n\n彈幕：『前世是大牌？』『這台太抽象了』『星間偶像的房間有洋芋片』。",
    options: [
      {
        label: "【穩健】立刻扶正頭顯，假裝那是空間異象",
        chance: 80,
        success: {
          log: "你扶得夠快。大多數人只看到閃光，世界觀勉強保住，只有眼尖的在考古。",
          fans: 100,
          san: -6,
          tech: 1,
        },
        failure: {
          log: "扶正時又掃到書桌。異象理論失敗，真實房間成為本週解析主題。",
          fans: 40,
          san: -14,
          drama: 16,
        },
      ...
      {
        label: "【標準】承認 VR 事故，並把場景切回安全待機",
        chance: 74,
        success: {
          log: "誠實過關。觀眾覺得你處理得體，VR 事故變成『也會跌倒的偶像』人設。",
          fans: 220,
          san: -2,
          talk: 2,
        },
        failure: {
          log: "切場景切到錯誤攝影機。安全待機不安全，第二輪真實房間登場。",
          fans: 10,
          san: -12,
          drama: 14,
        },
      ...
      {
        label: "【豪賭】乾脆開房間導覽，把世界觀改成『下凡中』",
        chance: 32,
        success: {
          log: "下凡設定爆紅。有人喜歡這種接地氣，訂閱因為洋芋片而增加，這很個人勢。",
          fans: 700,
          san: -10,
          talk: 4,
          drama: 14,
        ...
        failure: {
          log: "導覽導到不該被看見的證件角落。你光速切黑屏，解析文比你還快。",
          fans: -100,
          san: -24,
          drama: 28,
        },
      ...
      {
        label: "【迷因】宣布衣架是你的經紀人，以後都要出鏡",
        chance: 48,
        success: {
          log: "衣架經紀人成為新角色。觀眾開始點名它，你的事故變成虛擬團綜。",
          fans: 280,
          san: 2,
          talk: 3,
          drama: 10,
        ...
        failure: {
          log: "衣架梗沒撐過十分鐘。觀眾還是想看你的臉，不是你的房間。",
          fans: 20,
          san: -8,
          drama: 8,
        },
  ...
  {
    id: "donate-goal-panic",
    title: "【達成】目標條滿了，你卻忘了獎勵是什麼",
    description:
      "聊天室在歡呼。目標條從 0 走到 100%。你微笑點頭，然後發現備註只寫著『想一個很酷的』。🎉💀\n\n彈幕開始幫你回憶：『不是要唱原 key 嗎』『不是要做黑暗料理嗎』『不是要叫出中之人嗎』。你什麼都不記得。",
    options: [
      {
        label: "【穩健】承認忘記，改成現場點歌當成獎勵",
        chance: 82,
        success: {
          log: "點歌獎勵被接受。觀眾說至少有東西拿，你的記憶力成為新的迷因。",
          fans: 180,
          san: -2,
          singing: 2,
          talk: 1,
      ...
      {
        label: "【標準】翻舊直播備註，找到真正的獎勵並補做",
        chance: 66,
        success: {
          log: "你找到了，是黑暗料理。你當場做完，同接因為害怕而留下。",
          fans: 360,
          san: -8,
          talk: 2,
          drama: 6,
        ...
        failure: {
          log: "備註寫的是另一場的獎勵。你補錯活動，現場更混亂，但意外有趣。",
          fans: 80,
          san: -12,
          drama: 10,
        },
      ...
      {
        label: "【豪賭】讓聊天室投票決定『更過分的新獎勵』",
        chance: 30,
        success: {
          log: "投票獎勵比原案更瘋，你真的做了。這晚成為傳說，SAN 和訂閱一起爆炸。",
          fans: 980,
          san: -20,
          talk: 3,
          drama: 16,
        ...
        failure: {
          log: "投票選出你做不到的事。你當場食言，目標條的信任值歸零。",
          fans: -70,
          san: -18,
          drama: 20,
        },
      ...
      {
        label: "【迷因】宣布獎勵就是『我忘記獎勵』這個名場面本身",
        chance: 54,
        success: {
          log: "名場面理論成立。觀眾把這句做成表情貼，忘記獎勵變成你最被記住的達成。",
          fans: 260,
          san: 4,
          talk: 3,
          drama: 8,
        ...
        failure: {
          log: "贊助者想要實體獎勵。名場面沒能代替內容，你答應下週補做。",
          fans: -20,
          san: -8,
          drama: 10,
        },
  ...
  {
    id: "tl-team-crash",
    title: "【國際台】翻譯組當機，彈幕只剩注音與谷歌",
    description:
      "日文觀眾湧進來。翻譯組的帳號顯示離線。聊天室變成『ここホロライブ？』『草』『??????』以及你用注音回的『ㄢㄢ』。🌐😵‍💫\n\n你聽得懂一半，說得出四分之一。這是國際化，也是巴別塔。",
    options: [
      {
        label: "【穩健】切換慢速、多用肢體與短句，請觀眾互相翻譯",
        chance: 78,
        success: {
          log: "觀眾自發組成臨時 TL。溝通很慢，但溫暖，有人留下當新的翻譯志工。",
          fans: 220,
          san: -4,
          talk: 2,
        },
        failure: {
          log: "慢速變成冷場。語言空隙被刷屏填滿，你聽起來像在對空氣點頭。",
          fans: 40,
          san: -10,
          drama: 8,
        },
      ...
      {
        label: "【標準】打開翻譯軟體，接受延遲與錯譯當節目效果",
        chance: 64,
        success: {
          log: "錯譯意外好笑。『我喜歡木頭』本來是『我喜歡木吉他』，這晚多了新梗。",
          fans: 300,
          san: 2,
          talk: 3,
          drama: 6,
        ...
        failure: {
          log: "軟體把道歉譯成告白。國際事故發生，你花十分鐘用注音滅火。",
          fans: 20,
          san: -14,
          drama: 16,
        },
      ...
      {
        label: "【豪賭】全程用你會的三句日文撐完整場",
        chance: 28,
        success: {
          log: "三句日文加上靈魂。觀眾被這份努力感動，有人說比流利更像個人勢。",
          fans: 540,
          san: -12,
          talk: 4,
          drama: 8,
        ...
        failure: {
          log: "三句用完你開始重複。現場變成語言 CD 卡帶，國際觀眾禮貌地離開。",
          fans: -40,
          san: -16,
          drama: 10,
        },
      ...
      {
        label: "【迷因】宣布今晚官方語言是『注音』，請全世界跟上",
        chance: 46,
        success: {
          log: "注音革命意外成功。日文觀眾開始打 ㄅㄆㄇ，這場成為年度最抽象國際交流。",
          fans: 320,
          san: 2,
          talk: 3,
          drama: 12,
        ...
        failure: {
          log: "沒人跟上。注音變成只有你看得懂的彈幕，國際台變回單人卡拉 OK。",
          fans: 10,
          san: -8,
          drama: 8,
        },
